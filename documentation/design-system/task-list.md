...
See also: `documentation/design-system/epics.md`, `documentation/design-system/overview.md`, `documentation/testing/strategy.md`
...
- [x] Audit `documentation/ux/ui-design.md`, `documentation/design-system/styling-architecture.md`, and related docs for outdated or conflicting visual rules
