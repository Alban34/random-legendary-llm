...
Canonical token definitions and governance rules live in `documentation/design-system/overview.md`.

`documentation/ux/ui-design.md` remains the screen-level companion reference and `documentation/design-system/adoption-plan.md` records the rollout order for applying the shared primitives across Browse, Collection, New Game, History, and Backup.
...
- use `documentation/design-system/overview.md` as the authoritative reference when token names or intent are unclear
