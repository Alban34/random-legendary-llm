...
- `documentation/data/game-data-normalized.md`
...
- **Source of truth:** the two BoardGameGeek reference pages listed in `documentation/data/sources.md` are the authoritative source set.
...
> Classification in this project is a planning metadata layer for the UI and collection filters. The authoritative inventory and rule references come from the BoardGameGeek sources listed in `documentation/data/sources.md`.
...
See `documentation/data/game-data-normalized.md` for:
