...
|---|---|
| `documentation/data/game-data.md` | human-readable summary of scope and product coverage based on the card list page |
| `documentation/data/game-data-normalized.md` | normalized implementation-facing inventory derived from the card list page, with BGG-backed review checkpoints |
| `documentation/architecture/setup-rules.md` | setup logic and Scheme/Mastermind rule behavior aligned with the card text page |
| `documentation/data/data-model.md` | implementation-safe schema that preserves BGG-backed rule semantics |
| `documentation/architecture/overview.md` | runtime design for normalizing BGG-sourced data into app-safe structures |
| `documentation/testing/strategy.md` | requires implementation verification against the two BGG sources before story completion |
