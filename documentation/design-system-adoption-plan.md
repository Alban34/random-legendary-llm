...
It is the screen-level rollout companion to `documentation/design-system.md` and should be updated whenever a new screen or shared primitive changes the adoption sequence.
