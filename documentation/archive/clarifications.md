...
**Superseded note:**
This earlier decision has now been replaced by the source policy in `documentation/data/sources.md`.
...
- `documentation/data/data-model.md`
- `documentation/architecture/setup-rules.md`
- `documentation/ux/ui-design.md`
- `documentation/planning/roadmap.md`
- `documentation/data/game-data.md`
