...
- For the current shipped UX contract and active alignment work, use `documentation/ux/alignment/task-list.md` and `documentation/ux/ui-design.md`.

## Purpose

This file is the working checklist for implementation.

Each story from `documentation/planning/epics.md` is broken down into concrete tasks that can be checked off during development.
...
- [x] Reconcile implementation with `documentation/architecture/overview.md`
- [x] Reconcile implementation with `documentation/data/data-model.md`
- [x] Reconcile implementation with `documentation/architecture/setup-rules.md`
...
These epics are derived from the remaining unchecked items in `documentation/archive/next-steps.md`.
...
These epics are derived from the newly added unchecked items in `documentation/archive/next-steps.md` and are prepared for review before implementation starts.
