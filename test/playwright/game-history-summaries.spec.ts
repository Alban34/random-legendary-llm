...
import { gotoApp, readAppState, seedAllOwnedState, selectTab, setViewport } from './helpers/app-fixture.ts';
...
test.describe('History: accepted game summaries and usage indicators', () => {
