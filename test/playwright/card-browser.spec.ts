...
test.describe('Card browser', () => {
  ...
  test('By Category: owned Core Set shows five category section headings', async ({ page }) => {
    ...
    await expect(browser.locator('[data-category="heroes"] summary')).toBeVisible();
    await expect(browser.locator('[data-category="masterminds"] summary')).toBeVisible();
    await expect(browser.locator('[data-category="villainGroups"] summary')).toBeVisible();
    await expect(browser.locator('[data-category="henchmanGroups"] summary')).toBeVisible();
    await expect(browser.locator('[data-category="schemes"] summary')).toBeVisible();
  });
