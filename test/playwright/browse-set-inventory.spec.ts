...
import { getRuntimeSnapshot, gotoApp, selectTab } from './helpers/app-fixture.ts';

test.describe('Browse: set inventory and about panel', () => {
  ...
  test('surfaces initialization errors with understandable browser messaging', async ({ page }) => {
    await page.evaluate(async () => {
      const { renderInitializationError } = await import('./src/app/app-renderer.ts');
